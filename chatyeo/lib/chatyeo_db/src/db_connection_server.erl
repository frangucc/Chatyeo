...
%%--------------------------------------------------------------------
init([]) ->
    mysql:start_link(p1, ?DB_SERVER, ?CHATYEO_DB_USER, ?CHATYEO_DB_PASSWORD, ?CHATYEO_DB),

    lists:foreach (fun (_X) ->
                           mysql:connect(p1, ?DB_SERVER, undefined, ?CHATYEO_DB_USER, 
                                         ?CHATYEO_DB_PASSWORD, ?CHATYEO_DB, true)
                           end, lists:seq(1,20)),
